...
public class DDApplication extends Application { //Must extend Application
	static Map<String, Quotation> quotations = new HashMap<String,Quotation>();
	static Gson gson = new Gson();
	public DDQService ddqs = new DDQService();
	...
	public static void main (String[] args)  throws Exception {
      ...
      component.getDefaultHost().
          attach("", new DDApplication()); //left "" as only one application 
      component.start();
	}
		...
		router.attach("/quotations", new Restlet() {
		    public void handle(Request request, Response response) {
		         ...
		         if (request.getMethod().equals(Method.POST)) { //Post request
		            ...
		            Quotation quote = ddqs.generateQuotation(in);
