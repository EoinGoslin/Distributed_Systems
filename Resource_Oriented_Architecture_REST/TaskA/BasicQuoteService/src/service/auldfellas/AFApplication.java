...
public class AFApplication extends Application { //Must extend Application
	...
	public AFQService afqs = new AFQService(); //creating instance of class so that references used as key in Map are not the same
		...
		router.attach("/quotations", new Restlet() {
		    public void handle(Request request, Response response) {
		         ...
		         if (request.getMethod().equals(Method.POST)) { //Post request
		            ...
		            if (!quotations.containsKey(quote.reference)) { //if does not contain the key already
		               ...
		               // String jSoned = gson.toJson(quote);
		            	...
		            	//Otherwise, not allowed to post same key to the map
