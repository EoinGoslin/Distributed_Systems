...
public class GPApplication extends Application { //Must extend Application
	static Map<String, Quotation> quotations = new HashMap<String,Quotation>();
	static Gson gson = new Gson();
	public GPQService afqs = new GPQService();
	...
	public static void main (String[] args)  throws Exception {
      ...
      component.getDefaultHost().
          attach("", new GPApplication()); //left "" as only one application 
      component.start();
	}
